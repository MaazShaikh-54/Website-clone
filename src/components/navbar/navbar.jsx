        ...
        <>
            <nav className="block">
                <div className="flex items-center justify-between px-6 py-3">
                    <button className="menu-bar-btn pt-2 px-3 pb-1.5 cursor-pointer text-white bg-[#F06C30] border-0 rounded-xl font-bold" >Contact</button>
                ...
                <div className={`fixed top-15 left-0 h-screen w-screen bg-white z-50 overflow-y-auto transition-transform duration-300 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                    <div className="flex flex-col justify-between min-h-[calc(100vh-60px)] navbar-links text-sm font-medium">
                        <ul className="flex flex-col items-left w-full">
                            ...
                            <div className="flex justify-between items-center pr-4 cursor-pointer" onClick={() => setServicesOpen(!servicesOpen)}>
                                <li className="pl-4.5 py-2.5"><a className={`font-medium ${pathname === '/services' ? 'text-[#f06c30] font-black' : 'text-black'}`} href="/services">SERVICES</a></li>
                                {servicesOpen ? <ChevronDown size={16} /> : <ChevronRight size={16} />}
                            </div>
                            {servicesOpen && (
                                <ul className="flex flex-col pl-6 pb-8">
                        ...
                        <div className="pt-auto pb-4 px-4">
                            <h2 className="text-lg font-medium mb-1.5">Contact Info</h2>
                            <a href="tel:+912262226222" className="font-normal text-[15px] underline wrap-break-word leading-loose">+91 22-6222-6222</a><br />
